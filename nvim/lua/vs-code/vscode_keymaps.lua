...
keymap({"n", "v"}, "<leader>b", "<cmd>lua require('vscode').action('workbench.action.quickOpenView') <CR>")
keymap({"n", "v"}, "<leader>fa", "<cmd>lua require('vscode').action('workbench.action.quickOpenPreviousRecentlyUsedEditorInGroup') <CR>")
...
vim.api.nvim_set_keymap('n', '<C-j>', '<cmd>lua reuire("vscode").action("workbench.action.navigateDown")<CR>', {noremap = true, silent = true})
...
-- Project Manager
vim.keymap.set({"n", "v"}, "<leader>pw", "<cmd>lua require('vscode').action('projectManager.saveProject')<CR>")
vim.keymap.set({"n", "v"}, "<leader>pa", "<cmd>lua require('vscode').action('projectManager.listProjectsNewWindow')<CR>")
